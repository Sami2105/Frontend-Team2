          ...
          <Grid container spacing={2}  style={{ margin: "0em 3.5em" }}>
             <Grid item spacing={8}  style={{ margin: "0em 3em" }}>
                 ...
                 <Grid container spacing={2}  style={{ margin: "0em 3.5em" }}>
                     ...
                     <FormControl>
                       ...
                       name="radio-buttons-group"
                        >
                          <FormControlLabel value="female" control={<Radio />} label="Activ" />
                          <FormControlLabel value="male" control={<Radio />} label="Inactiv" />
                        </RadioGroup>
                      </FormControl>          
                     </Grid>
                     ...
                     <Grid item spacing={2}  style={{ margin: "4em 6em" }}>
                       ...
                       <FormGroup>
                           <FormControlLabel control={<Checkbox defaultChecked />} label="Donare" />
                 ...
                 <Grid container spacing={2}  style={{ margin: "0em 3.5em" }}>
                     <Grid item spacing={8}  style={{ margin: "0em 3em" }}>
                        <Typography  align="center" gutterBottom>
                         ...
                         <FormGroup>
                           <FormControlLabel control={<Checkbox defaultChecked />} label="Mobilă" />
                ...
                <Grid item spacing={2}  style={{ margin: "0em 6em" }}>
                 ...
                 <Grid item style={{ margin: "1em 0em" }}><Cards></Cards></Grid>
                 <Grid item style={{ margin: "1em 0em" }}><Cards></Cards></Grid>
                 <Grid item style={{ margin: "1em 0em" }}><Cards></Cards></Grid>
                 <Grid item style={{ margin: "1em 15em" }}><Pagination count={11} defaultPage={6} siblingCount={0}  /></Grid>      
               </Grid>          
          </Grid>
